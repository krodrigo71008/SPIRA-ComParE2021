...
if __name__ == '__main__':
    ...
    experiments_dir = ["logs/Tosse/Experiments_Final/Experiment-1","logs/Tosse/Experiments_Final/Experiment-2/", "logs/Tosse/Experiments_Final/Experiment-3/", "logs/Tosse/Experiments_Final/Experiment-4/", "logs/Tosse/Experiments_Final_one_window_Final/Experiment-1/", "logs/Tosse/Experiments_Final_one_window_Final/Experiment-2/", "logs/Tosse/Experiments_Final_one_window_Final/Experiment-3/", "logs/Tosse/Experiments_Final_one_window_Final/Experiment-4/","logs/Tosse/Experiments_Final_kfolds/Experiment-1","logs/Tosse/Experiments_Final_kfolds/Experiment-2/", "logs/Tosse/Experiments_Final_kfolds/Experiment-3/", "logs/Tosse/Experiments_Final_kfolds/Experiment-4/"]
...
CUDA_VISIBLE_DEVICES=0  nohup  python test_ensambles_all_models_tosse.py  --test_csv ../data/compare/ComParE2021_CCS/lab/devel.csv -r ../data/compare/ComParE2021_CCS/wav  --batch_size 30 --debug 0   --output_csv logs/Tosse/Ensamble_results/ensamble_tosse_all_eval.csv  &
CUDA_VISIBLE_DEVICES=0  nohup  python test_ensambles_all_models_tosse.py  --test_csv ../data/compare/ComParE2021_CCS/lab/test.csv -r ../data/compare/ComParE2021_CCS/wav  --batch_size 30 --debug 0   --output_csv logs/Tosse/Ensamble_results/ensamble_tosse_all_test.csv  &
'''
